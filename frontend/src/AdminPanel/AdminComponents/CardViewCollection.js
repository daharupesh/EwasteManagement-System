...
export default function CardViewCollection() {
  return (
    <div>
      <section>
  <div className="container-fluid " style={{"width":"1000px","height":"50px"}}>
    <div className="row justify-content-center mb-3">
      <div className="col-12 col-10">
        <div className="card shadow-0 border rounded-3 ">
          <div className="card-body w-100">
            <div className="row">
              <div className="col-12 col-8 col-8 mb-4 mb-lg-0">
              ...
              <div className="col-6 col-6 col-6">
